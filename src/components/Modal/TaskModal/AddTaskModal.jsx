      ...
      <form onSubmit={handleAddTask}>
        ...
        >
          ...
          <div className='modal__input-container'>
            ...
            />
            {errorHours && (
              <p className='modal-input__error__message--hours'>
          ...
          <div className='modal__input-container'>
            ...
            <input
              ...
              className={`modal-input ${
                errorCreationDate && 'modal-input__error'
              }`}
              value={creationDate}
              onChange={(e) => {
                setCreationDate(e.target.value)
                if (errorCreationDate && e.target.value !== '') {
                  setErrorCreationDate(false)
                }
              }}
            />
            {errorCreationDate && (
              <p className='modal-input__error__message--date'>
